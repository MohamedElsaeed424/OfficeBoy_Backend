  ...
  */
  ...
  export interface UsersTBLDelegate<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> {
    ...
    **/
     ...
     * const usersTBLWithUser_idOnly = await prisma.usersTBL.findMany({ select: { User_id: true } })
     * 
    **/
  ...
  interface UsersTBLFieldRefs {
    readonly User_id: FieldRef<"UsersTBL", 'Int'>
  ...
  export type UsersTBLWhereInput = {
    ...
    User_id?: IntFilter<"UsersTBL"> | number
  ...
  export type UsersTBLScalarWhereWithAggregatesInput = {
    ...
    User_id?: IntWithAggregatesFilter<"UsersTBL"> | number
