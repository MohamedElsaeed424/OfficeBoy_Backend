...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'tokensTBL' | 'blacklistedToken' | 'usersTBL' | 'employeeTBL' | 'officeBoyTBL' | 'siteTBL' | 'buildingTBL' | 'officeTBL' | 'departmentTBL' | 'roomTBL' | 'categoriesTbl' | 'itemsTBL' | 'ordersTBL' | 'cartTBL' | 'cartItemsTBL'
